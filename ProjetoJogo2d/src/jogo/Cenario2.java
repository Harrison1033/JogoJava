...
public class Cenario2 extends Cenario {//COLOCAR �TENS PARA RECUPERA��O DA VIDA DO PERSONAGEM
	...
	public Cenario2 (Window window) {//AP�S CONTATO COM O �TME, JOGAR LONGE COMO O ZUMBI
		janela = window;
		cena = new Scene();
